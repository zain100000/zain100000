...
| :--- | :--- |
| **Mobile Development** | `React Native (CLI)` • `Redux Toolkit` • `Context API` |
...
I am actively looking to connect with engineering teams, remote technical recruiters, and open-source collaborators. 

* 💼 **Looking for:** Part-Time / Full-Time Remote Contracts in Mobile or Web Development.
* 📬 **Reach out via email:** [zabideen639@gmail.com](mailto:zabideen639@gmail.com)
* 🌐 **Connect on LinkedIn:** [Muhammad Zain-ul-Abideen](https://linkedin.com/in/muhammad-zain-ul-abideen-270581272)
